...
namespace SharpMap.Styles
{
    ...
    public class LabelStyle : Style
    {
        ...
        public LabelStyle Clone()
        {
            ...
            ls.BackColor = BackColor;
            ls.CollisionBuffer = CollisionBuffer;
            ls.CollisionDetection = CollisionDetection;
            ls.Enabled = Enabled;
            ls.Font = Font;
            ls.ForeColor = ForeColor;
            ls.Halo = Halo;
            ls.HorizontalAlignment = HorizontalAlignment;
            ls.MaxVisible = MaxVisible;
            ls.MinVisible = MinVisible;
            ls.Offset = Offset;
            ls.VerticalAlignment = VerticalAlignment;
